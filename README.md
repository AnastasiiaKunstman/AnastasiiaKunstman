      ...
      <td >
        <h3 >Обо мне :</h3>
          <ul > 
            ...
            <li>❤️: JavaScript</li>
            <li>👩‍🎓: за плечами курсы Яндекс.Практикума по frontend-разработке </li>
            <li>💊: более 5 лет проработала на BigFarma</li>
            <li>💥: вы можете посетить мой <a href="" target="blank">сайт</a>, чтобы узнать меня лучше</li>
          </ul>
         <br />
      </td>
    </tr>
